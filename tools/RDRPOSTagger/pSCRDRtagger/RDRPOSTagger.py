...
#    os.path.abspath(os.path.join(os.path.abspath(os.path.join(os.getcwd(),"../")),'tools/RDRPOSTagger/'))
os.chdir(path)
...
from SCRDRlearner.Object import FWObject# SCRDRlearner.Object import FWObject
